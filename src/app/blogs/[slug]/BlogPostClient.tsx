          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <article className="lg:col-span-8 space-y-6">
              ...
              {post.internal_links && post.internal_links.length > 0 && (
                <div className="bg-gradient-to-br from-gray-50 to-yellow-50/30 rounded-3xl border border-zinc-200 p-6 md:p-8 mt-10 shadow-sm">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="p-2.5 bg-[#f5c80c]/20 text-[#1e2a32] rounded-xl shrink-0">
                    ...
                    {post.internal_links.map((link) => {
                      ...
                      return (
                        <LinkTag
                          key={link.id}
                          {...linkProps}
                          className="group flex items-center gap-3 p-4 bg-white rounded-2xl border border-zinc-200 hover:border-[#f5c80c] hover:shadow-md transition-all duration-200"
                        >
                          <div className="w-8 h-8 rounded-lg bg-[#f5c80c]/10 flex items-center justify-center shrink-0 group-hover:bg-[#f5c80c]/20 transition-colors">
                            <svg className="w-4 h-4 text-[#1e2a32] group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9 5l7 7-7 7" />
                            </svg>
                          </div>
                          <span className="text-sm font-bold text-[#1e2a32] group-hover:text-[#f5c80c] transition-colors leading-snug">
                            {link.anchor_text}
                          </span>
                          {isExternal && (
                            <svg className="w-3.5 h-3.5 text-zinc-400 ml-auto shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
